...
describe('BlogPostDetailComponent', () => {
  ...
  describe('#ngOnInit', () => {
    it('should load post details after get post id', () => {
      ...
      expect(postsServiceSpy.getById).toHaveBeenCalledWith(blogPostId);
      expect(commentsServiceSpy.getById).toHaveBeenCalledWith(blogPostId);
    });
  });

  describe('#loadComments', () => {
    it('should have called the method loadComments with correct parameter', () => {
      component.loadComments(blogPostId);
      fixture.detectChanges();
